...
export default {
  ...
  elements: {
    ...
    customize: `<div style='padding: 8px'><a aria-label="dismiss cookie message" tabindex="0" class=" cc-${statusDismiss}">{{customize}}</a></div>`
  ...
  compliance: {
    ...
    'opt-in':
      '{{customize}}<div class="cc-compliance cc-highlight">{{dismiss}}{{allow}}</div>',
    'opt-out':
      '{{customize}}<div class="cc-compliance cc-highlight">{{dismiss}}{{deny}}</div>',
    'opt-in-detail':
  ...
  layouts: {
    ...
    'detail'      : '{{messagelink}}<div class="form">{{categories}}</div>{{compliance}}'
