...
export default {
  ...
  elements: {
    ...
    categories: '<ul class="cc-categories">' +
      categories.map( ( category, index ) =>
        `<li class="cc-category cc-highlight">
  ...
  elementsEn: {
    ...
    message:
      '<span id="cookieconsent:desc" class="cc-message">{{message}}</span>' ,
    messagelink:
      '<span style="margin:10px;display: flex;flex-direction: column;"><select style="width:40px;align-self: flex-end;" name="lang" id="lang"><option value="en">EN</option><option value="th">TH</option></select></span>'+
      '<span id="cookieconsent:desc" class="cc-message">{{message}} <a aria-label="learn more about cookies" role=button tabindex="0" class="cc-link" href="{{href}}" rel="noopener noreferrer nofollow" target="{{target}}">{{link}}</a></span>',
    dismiss:
      `<a aria-label="dismiss cookie message" role=button tabindex="0" class="cc-btn cc-${statusDismiss}">{{dismiss}}</a>`,
    allow:
  ...
  elementsTh: {
    ...
    message:
      '<span id="cookieconsent:desc" class="cc-message">{{message}}</span>' ,
    messagelink:
      '<span style="margin:10px;display: flex;flex-direction: column;"><select style="width:40px;align-self: flex-end;" name="lang" id="lang"><option value="th">TH</option><option value="en">EN</option></select></span>'+
      '<span id="cookieconsent:desc" class="cc-message">{{message}} <a aria-label="learn more about cookies" role=button tabindex="0" class="cc-link" href="{{href}}" rel="noopener noreferrer nofollow" target="{{target}}">{{link}}</a></span>',
    dismiss:
      `<a aria-label="dismiss cookie message" role=button tabindex="0" class="cc-btn cc-${statusDismiss}">{{dismiss}}</a>`,
    allow:
